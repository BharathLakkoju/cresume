            ...
            <motion.div style={{ y: leftY }} className="will-change-transform">
              <div className="rounded-2xl bg-surface-lowest p-8 shadow-ambient">
                ...
                <div className="mt-8 flex items-center gap-4">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-surface-low font-display text-sm font-semibold text-muted-foreground">
                  ...
                  <div>
                    ...
                    <p className="label-sm text-muted-foreground">{testimonials[0].role}</p>
                  </div>
                </div>
              </div>
            </motion.div>
              ...
              <div className="rounded-2xl bg-surface-lowest p-8 shadow-ambient">
                ...
                <div className="mt-8 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="label-sm text-muted-foreground">{testimonials[1].role}</p>
                  </div>
                </div>
              </div>
            </motion.div>
